...
node0.addService(pg.Execute(shell="sh", command="bash /local/repository/webserverSetup.sh"))
...
node0.addService(pg.Execute(shell="sh", command="bash /local/repository/observerSetup.sh"))
